...
- Alternate dark hero/signature surfaces with spacious white editorial content, tools and forms, following Daniel's supplied intelligence-snapshot-studio-report-template.png. On white, teal text uses #007D75 for contrast; primary buttons retain #00E5D1 with navy text. Use restrained teal gradients, fine borders and dot-grid accents. Lucide icons remain in use.
