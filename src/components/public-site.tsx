...
const navItems = [
  ["/tattoo-studio-software", "Product"],
  ["/studio-growth-check", "Growth Check"],
    ...
    <>
      ...
      <header className="site-header sticky top-0 z-50 border-b border-border/50 bg-ink-deep/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-6">
          <Link to="/" aria-label="INKSIGHT home">
            <Logo />
          </Link>
          <nav
            className="hidden items-center gap-6 text-sm font-semibold text-muted-foreground lg:flex"
  ...
  const groups = [
    {
      title: "Product",
      links: [
        ["/tattoo-studio-software", "INKSIGHTS platform"],
        ["/studio-growth-check", "Studio Growth Check"],
        ["/studio-map", "UK Studio Map"],
        ["/offers", "Current solutions"],
      ],
    },
    {
      title: "Resources",
        ...
        <div className="grid gap-10 lg:grid-cols-[1.25fr_2fr]">
          <div>
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Revenue intelligence and growth systems designed specifically for UK tattoo studios.
            </p>
            <a
