...
const CANONICAL_URL = "https://getinksights.co.uk/terms";
...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Website and Service Terms | INKSIGHTS" },
      { name: "description", content: "Terms for using the INKSIGHTS website, tools, educational content and scoped tattoo studio services." },
...
function TermsPage() {
  return (
    ...
    >
      ...
      <p>INKSIGHTS provides information, interactive tools and services intended primarily for UK tattoo studios, with a separate client-education resource section. Website access does not create a consultancy or service contract.</p>
      ...
      <p>A paid engagement begins only when INKSIGHTS and the client agree the offer, scope, price, access, dependencies and delivery conditions. Where the public offer page and an agreed written scope differ, the later agreed written scope governs.</p>
      ...
      <p>INKSIGHTS may offer an optional performance-linked fee only as part of a signed written scope. It is not a standalone public checkout product and there is no default public performance-fee percentage.</p>
      ...
      <p>Where INKSIGHTS cannot accept or commence a fixed-scope engagement, payment should be returned. Once client-specific work has begun, any refund is limited to undelivered work unless the written scope states otherwise or a legal right applies.</p>
      <p>For monthly subscriptions, no partial-period refund is promised except where a legal right applies or INKSIGHTS agrees otherwise in writing. For minimum-term implementation or management packages, the signed service order governs early termination, completed work and any remaining commitment.</p>
      ...
      <p>INKSIGHTS does not guarantee search rankings, platform visibility, enquiry volume, bookings, retention, revenue or a specific return on investment. Results depend on market conditions, studio reputation, offer quality, implementation, access, timing, platform changes and other factors outside INKSIGHTS&apos;s control.</p>

      <h2>Third-party services</h2>
      <p>The website may discuss or link to software, platforms and external guidance. Product features, pricing and availability can change. Verify current vendor documentation before purchasing or migrating. INKSIGHTS is not responsible for third-party outages, policy changes or external content.</p>

      <h2>Communications and automation</h2>
      <p>Clients remain responsible for approving their booking, cancellation, consent, privacy and marketing policies. INKSIGHTS does not replace professional legal advice and will not intentionally send unapproved marketing communications. Automated systems must retain an appropriate human exception and escalation route.</p>
      ...
      <p>Unless stated otherwise, INKSIGHTS owns the website design, copy, tools, assessment logic, original graphics and service materials. You may link to public pages and share normal excerpts with attribution. You may not reproduce substantial parts, resell tools or remove branding without permission.</p>

      <h2>Liability</h2>
      <p>Nothing in these terms excludes liability that cannot lawfully be excluded. Subject to that, INKSIGHTS is not responsible for indirect or consequential loss arising solely from reliance on free website content, estimates or third-party information. Paid-service liability may also be addressed in the agreed service order.</p>

      <h2>Changes and availability</h2>
      <p>Pages, tools, offers and prices may be updated, withdrawn or replaced. INKSIGHTS may suspend access for maintenance, security or legal reasons. Material commercial changes receive a new policy version and should be reflected in the relevant checkout, proposal or service order.</p>
