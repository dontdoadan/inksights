...
const CANONICAL_URL = "https://getinksights.co.uk/privacy";

export const Route = createFileRoute("/privacy")({
  component: PrivacyPage,
  head: () => ({
    meta: [
      { title: "Privacy Notice | INKSIGHTS" },
      { name: "description", content: "How INKSIGHTS collects, uses, stores and protects personal information submitted through the website." },
...
function PrivacyPage() {
  return (
    <LegalPage
      ...
      description="This notice explains how INKSIGHTS handles personal information submitted through the public website, assessments, contact forms and business relationship."
    >
      <h2>Who controls the information?</h2>
      <p>INKSIGHTS is the controller for personal information collected directly through this website. Privacy questions and rights requests can be sent to <a href="mailto:contact@getinksight.co.uk">contact@getinksight.co.uk</a>.</p>
      ...
      <p>INKSIGHTS uses service providers for website hosting, databases, CRM, source control, automation, email, calendar and advertising measurement. Current systems may include Supabase, GitHub, HubSpot, Google services, n8n and Meta where enabled. Providers receive only the information needed for their role and are subject to their own security and data-processing terms.</p>

      <h2>International transfers</h2>
      <p>Some technology providers may process information outside the United Kingdom. Where this occurs, INKSIGHTS will rely on an appropriate transfer mechanism or the provider's applicable safeguards.</p>
      ...
      <p>INKSIGHTS does not sell personal information to advertisers. Meta Pixel remains disabled until marketing consent is selected. Changing cookie preferences does not affect essential website functions.</p>
