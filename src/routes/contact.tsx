  ...
  head: () => ({
    meta: [
      { title: "Contact INKSIGHTS" },
      {
        name: "description",
        content:
          "Contact INKSIGHTS about tattoo studio growth, existing-client support, billing, cancellations, partnerships or website support.",
      },
      ...
      <PageHero
        ...
        description={
          <>
            ...
            recommendation should normally start with the free Studio Growth Check.
          </>
        }
      />
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[.8fr_1.2fr] md:py-24">
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-border bg-ink p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                The Revenue Audit collects enough commercial context to recommend a useful route
              ...
              >
                Start the free Studio Growth Check
              </a>
            </div>
            <div className="rounded-2xl border border-border bg-ink p-6">
