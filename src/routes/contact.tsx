  ...
  head: () => ({
    meta: [
      { title: "Contact INKSIGHT" },
      {
        name: "description",
        content:
          "Contact INKSIGHT about tattoo studio growth, existing-client support, billing, cancellations, partnerships or website support.",
      },
    ...
    if (functionError || !data?.ok) {
      ...
      setError(
        functionError?.message ||
          data?.error ||
          "The message could not be recorded. Email dontdoadan@icloud.com instead.",
      );
      return;
    }
    setStatus("done");
  ...
  return (
    <PublicShell>
      <PageHero
        ...
        description={
          <>
            Use the form for existing-client support, billing or cancellation questions, offer
            scope, partnerships, technical issues or general enquiries. Studio owners seeking a
            recommendation should normally complete the free Growth Check first.
          </>
        }
      />
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-border bg-ink p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Existing clients can review billing, cancellation, delivery and technical support
                guidance before submitting a message.
              </p>
              <a
                href="/support"
                className="mt-5 inline-flex rounded-full border border-mint px-5 py-3 text-sm font-bold text-mint"
              >
            ...
            <div className="rounded-2xl border border-border bg-ink p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                The Growth Check collects enough commercial context to recommend a useful route
                rather than beginning with an unstructured sales message.
              </p>
              <a
            ...
            <div className="rounded-2xl border border-border bg-ink p-6">
              ...
              <a href="/privacy" className="mt-4 inline-block text-sm font-bold text-mint">
            ...
            {status === "done" ? (
              <div className="flex min-h-[480px] flex-col justify-center">
                ...
                <p className="mt-4 max-w-xl leading-relaxed text-muted-foreground">
                  INKSIGHT will review the message and reply using the email provided. No payment or
                  booking has been created.
                </p>
                <div className="mt-7">
                  <a
                    href="/resources"
                    className="inline-flex rounded-full border border-mint px-5 py-3 font-bold text-mint"
                  >
                    Browse resources
                  </a>
                </div>
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <Field label="Topic" required>
                    <select name="topic" required className="form-control">
                      ...
                      <option value="billing-cancellation">
                        Billing, subscription or cancellation
                      </option>
                ...
                <Field label="Message" required>
                  <textarea
                    ...
                    placeholder="Include the studio, relevant links or references, what happened and the outcome you need. Do not include passwords, full card details, private API keys or verification codes."
                  />
                </Field>
                ...
                <label className="flex items-start gap-3 rounded-xl border border-border bg-ink-deep p-4 text-sm leading-relaxed text-muted-foreground">
                  ...
                  />
                  <span>
                    I agree that INKSIGHT may store and use these details to respond to this
