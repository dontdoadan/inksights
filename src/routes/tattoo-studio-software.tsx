...
const evaluationAreas = [
  ...
  ["5. Communication", "Can confirmations, reminders, preparation, follow-up and rebooking be automated with a human escalation path?"],
  ...
  return (
    <PublicShell>
      ...
      <PageHero
        ...
        description={<>The correct platform is not necessarily the one with the longest feature list. It is the one that reliably moves a custom request from enquiry to approval, deposit, consent, appointment, client guidance and repeat booking with the least duplicate administration.</>}
      />
