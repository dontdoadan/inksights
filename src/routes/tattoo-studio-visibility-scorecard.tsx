...
const sections: readonly Section[] = [
  ...
  },
  {
    ...
    checks: [
      { id: "aftercare", label: "Post-session client follow-up is standardised and easy to revisit.", evidence: "A clear follow-up route for review requests, healed-work collection, rebooking or client reactivation." },
