      ...
      <PageHero
        ...
        description={
          <>
            ...
            uses this as a diagnostic framework, not a guarantee: the inputs, constraints and
            measured outcome still have to be verified.
          </>
        }
      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <PrimaryButton href="/studio-growth-check">
              Start with the free Studio Growth Check
            </PrimaryButton>
            <SecondaryButton href="/offers/revenue-audit">
              Review the Full INKSIGHTS Audit
            </SecondaryButton>
          </div>
