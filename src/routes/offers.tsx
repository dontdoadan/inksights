      ...
      <section className="border-b border-border bg-ink">
        <div className="mx-auto max-w-7xl px-6 py-10">
          <SectionHeading
            ...
            title="Free check. Paid audit. Evidence before expansion."
            description="Start with the free Studio Growth Check or discuss the paid Full INKSIGHTS Audit. The diagnostic engine, growth playbooks and action/result tracking are in active build. The scopes below describe individual services; they do not imply a fully connected platform or a validated full loop. Wider integrations and acquisition follow validation on one real business."
          />
        </div>
      </section>
      <section>
