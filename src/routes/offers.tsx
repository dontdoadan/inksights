        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-2">
            {publicOffers.map((offer) => (
              <a key={offer.slug} href={`/offers/${offer.slug}`} className="group flex h-full flex-col rounded-3xl border border-border bg-ink p-7 transition hover:border-mint md:p-9">
