  ...
  head: () => ({
    meta: [
      { title: "UK Tattoo Studio Map | INKSIGHTS" },
      {
        name: "description",
        content:
          "Explore an interactive geographic index of tattoo studios across the UK, with studio records, locations and future verification and claiming features.",
      },
    ],
  }),
});
    ...
    <PublicShell>
      ...
      <section className="border-t border-border bg-ink">
        <div className="mx-auto max-w-5xl px-6 py-16 text-center md:py-20">
          ...
          <h2 className="mt-4 font-display text-3xl font-black text-ice md:text-5xl">
            Claim your studio when verification opens.
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            The long-term directory will allow studio owners to claim a public profile, correct
            information and establish a verified relationship with their studio record.
          </p>
        </div>
      </section>
    </PublicShell>
