  ...
  head: ({ params }) => {
    ...
    return {
      meta: [
        ...
        {
          name: "description",
          content: offer?.summary || "INKSIGHT tattoo studio growth solution.",
        },
    ...
    return (
      <PublicShell>
        <PageHero
          ...
          description="Return to the complete INKSIGHT offer catalogue."
          compact
        >
    ...
    <PublicShell>
      ...
      {search.checkout === "success" && (
        <div className="border-b border-mint/30 bg-mint/10 px-6 py-4 text-center text-sm font-medium text-mint">
          Payment successful. Thank you — INKSIGHT will contact you within one working day to begin
          intake.
        </div>
      )}
