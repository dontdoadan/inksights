...
const CANONICAL_URL = "https://getinksights.co.uk/accessibility";

export const Route = createFileRoute("/accessibility")({
  component: AccessibilityPage,
  head: () => ({
    meta: [
      { title: "Accessibility Statement | INKSIGHTS" },
      { name: "description", content: "INKSIGHTS's accessibility approach, current features and how to report a barrier." },
...
function AccessibilityPage() {
  return (
    <LegalPage
      ...
      description="INKSIGHTS aims to make public tools, articles and service information usable across devices, input methods and assistive technologies."
    >
