  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tattoo Studio Growth Tools & Guides | INKSIGHTS" },
      {
        ...
        content:
          "Practical tools for UK tattoo studio owners, plus a small library of client education worth sharing.",
      },
...
const clientResources = [
  {
    ...
    type: "Client guide",
    description:
      "A practical explanation of why viral pain maps are only a rough guide and how placement, technique and individual tolerance interact.",
    href: "/tools/tattoo-pain-chart-reality-check",
  },
  {
    icon: Calculator,
    title: "How Much Does a Full Sleeve Cost in the UK?",
    type: "Pricing guide",
    description:
      "A transparent framework for comparing day rates, hourly rates and multi-session sleeve budgets.",
    href: "/guides/full-sleeve-cost-uk",
  },
  {
    icon: BookOpen,
    title: "Grey-Line Healing: Week-by-Week",
    type: "Healing education",
    description:
      "A cautious guide to normal visual changes during healing and when professional advice may be appropriate.",
    ...
    <PublicShell>
      <JsonLd
        data={{
          ...
          url: CANONICAL_URL,
          description: "Tattoo studio growth tools and selected client education.",
        }}
      />
      <PageHero
        ...
        description={
          <>
            The primary library is built for tattoo studio owners and operators: diagnose
            performance, test visibility, compare workflows and model revenue. A smaller
            client-education section contains resources studios can share with customers.
          </>
        }
      />
      <ResourceSection
        ...
        description="Use these tools to identify what is restricting demand, bookings or revenue."
        resources={studioResources}
      />
      <ResourceSection
        eyebrow="For your clients"
        title="Useful education worth sharing."
        description="A secondary library for common client questions about pricing, pain and healing."
      ...
      <section>
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          <SectionHeading
            ...
            description="Where resources use public prices, competitor features or health-related guidance, they distinguish evidence from examples and avoid universal claims. Studio-facing resources are built around real operational decisions rather than keyword volume."
          />
        </div>
      </section>
      <CtaSection
        title="Start with the studio diagnosis."
        description="Run the free Studio Growth Check and use the result to decide whether a visibility fix, revenue audit, booking intervention or deeper intelligence work is justified."
      />
    </PublicShell>
  );
}
