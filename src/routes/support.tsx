  ...
  return (
    <PublicShell>
      ...
      <PageHero
        ...
        description={
          <>
            Support for existing INKSIGHT clients, billing and cancellations, website problems,
            privacy requests and questions about current service delivery. For a new studio
            recommendation, use the free Growth Check instead.
          </>
        }
      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            <Card>
              ...
              <h2 className="mt-5 font-display text-xl font-black text-ice">
                Existing client support
              </h2>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Include your studio name, service or written scope, the relevant page or workflow,
                what happened and the outcome you need.
              </p>
              <a
                href="/contact"
                className="mt-5 inline-block text-sm font-bold text-mint hover:text-mint-soft"
              >
            ...
            <Card>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Include the studio name, billing email, offer name, invoice or receipt reference if
                available, and the transaction or renewal you are asking about.
              </p>
              <a
                href="/contact"
                className="mt-5 inline-block text-sm font-bold text-mint hover:text-mint-soft"
            ...
            <Card>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Send the page URL, device and browser, the steps that caused the issue, what you
                expected to happen and a screenshot where useful.
              </p>
              <a
                href="/contact"
                className="mt-5 inline-block text-sm font-bold text-mint hover:text-mint-soft"
            ...
            <Card>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Use the contact email for access, correction, deletion, restriction, objection,
                portability or consent questions where those rights apply.
              </p>
              <a
                href="/privacy"
                className="mt-5 inline-block text-sm font-bold text-mint hover:text-mint-soft"
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            <Card className="bg-ink-deep">
              ...
              <h2 className="mt-5 font-display text-2xl font-black text-ice">
                72-Hour Studio Visibility Fix
              </h2>
              <p className="mt-2 font-bold text-mint">£249 one-off</p>
              <ul className="mt-5 space-y-3 text-sm leading-relaxed text-muted-foreground">
                <li>Payment is due before work begins.</li>
                <li>
                  The three-working-day delivery period begins only after payment, complete intake,
                  required access and a named approver are in place.
                </li>
                <li>
                  Delays in access, information or approvals can pause delivery or change the
                  delivery date.
                </li>
              </ul>
              <a
                href="/offers/72-hour-visibility-fix"
            ...
            <Card className="bg-ink-deep">
              <CreditCard className="h-7 w-7 text-mint" />
              <h2 className="mt-5 font-display text-2xl font-black text-ice">
                Tattoo Studio Visibility Watch
              </h2>
            ...
            <Card className="bg-ink-deep">
              ...
              <p className="mt-2 font-bold text-mint">
                £1,500 installation + £750/month for a minimum three-month management term
              </p>
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground">
                The standard minimum package totals £3,750. The signed service order governs the
                client-specific scope, access requirements, delivery, early termination and any
                remaining commitment.
              </p>
              <a
                href="/offers/founding-studio-pilot"
                className="mt-5 inline-block text-sm font-bold text-mint"
              >
                View the pilot
              </a>
            ...
            <Card className="bg-ink-deep">
              ...
              <h2 className="mt-5 font-display text-2xl font-black text-ice">
                Revenue Audit & Booking / Retention work
              </h2>
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground">
                These are scoped services rather than fixed public checkouts. The agreed written
                quote or scope controls the price, payment schedule, dependencies and delivery
                conditions for that engagement.
              </p>
              <a href="/offers" className="mt-5 inline-block text-sm font-bold text-mint">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-2 md:py-24">
          <div>
            <SectionHeading
              ...
              title="What the current policy says."
            />
            <div className="mt-7 space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                If INKSIGHT cannot accept or commence a fixed-scope engagement, payment should be
                returned. Once client-specific work has begun, any refund is limited to undelivered
                work unless the written scope states otherwise or a legal right applies.
              </p>
              <p>
                Monthly subscriptions do not promise a partial-period refund except where a legal
                right applies or INKSIGHT agrees otherwise in writing. Minimum-term implementation
                or management packages follow the signed service order for early termination,
                completed work and any remaining commitment.
              </p>
              <p>Nothing in the service terms limits a right that cannot lawfully be excluded.</p>
            </div>
            <a
              href="/terms"
              className="mt-6 inline-block text-sm font-bold text-mint hover:text-mint-soft"
            >
              Read the full terms
            </a>
          </div>
          ...
          <div className="rounded-3xl border border-amber-300/30 bg-amber-300/10 p-7 md:p-9">
            ...
            <p className="mt-4 text-sm leading-relaxed text-amber-100/85">
              Never send your password, a full payment-card number, card security code, private API
              key, one-time verification code or another person&apos;s confidential information.
              INKSIGHT can investigate normal billing and technical issues using references,
      ...
      <section className="bg-ink-deep">
        <div className="mx-auto max-w-5xl px-6 py-16 text-center md:py-24">
          ...
          <h2 className="mt-5 font-display text-4xl font-black text-ice md:text-5xl">
            Still need help?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-muted-foreground">
            Send a clear description of the issue through the secure contact form or email{" "}
            {SUPPORT_EMAIL}. If your signed scope contains a specific support or escalation process,
            use that process first.
          </p>
