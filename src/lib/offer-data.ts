...
export const publicOffers: PublicOffer[] = [
  ...
  {
    slug: "revenue-audit",
    name: "Full INKSIGHTS Audit",
    eyebrow: "Paid · scoped commercial diagnosis",
    ...
    summary:
      "A paid, individually scoped review of available studio evidence, from discovery and enquiry through booking, capacity, revenue and client return. The automated diagnostic engine is in active build; data access, analysis and deliverables are agreed in writing.",
    problem:
