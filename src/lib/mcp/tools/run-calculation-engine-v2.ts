...
export default defineTool({
  ...
  description:
    "Run the canonical INKSIGHTS V2 three-lever economic model. Returns low/base/high unconstrained and capacity-constrained revenue opportunity, optional contribution opportunity, evidence quality, reconciliation diagnostics and explicit warnings.",
  inputSchema: {
    ...
    gross_margin_rate: qualityRate.optional().describe("Observed or evidence-backed gross margin rate as a 0-1 decimal."),
    ...
    evidence: z.array(z.object({
      source_reliability: qualityRate.optional(),
      completeness: qualityRate.optional(),
      confidence: qualityRate.optional(),
